left_dim = 256;
right_dim = 128;
Al = read_bin('../data/test5_256x128_curl_left.dat', left_dim / 2 + 1, left_dim + 1);
Ar = read_bin('../data/test5_256x128_curl_right.dat', right_dim / 2 + 1, right_dim + 1);
...
plot(yl, Al(x_fix, :, time_step) - Al(x_fix, :, 1))
plot(yr, Ar(x_fix, :, time_step) - Ar(x_fix, :, 1))
