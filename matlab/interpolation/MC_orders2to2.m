function [IC2F,IF2C] = MC_orders2to2(mc)
% Input: mc = number of grid points in the coarse domain
...
for i = BCrows+1 : mc-BCrows
	IF2C(i,(2*i-stencil_halfwidth-1) :(2*i+stencil_halfwidth-1)) = stencil_F2C;
end
