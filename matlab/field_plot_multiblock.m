left_dim = 128;
right_dim = 128;
Al = read_bin('../data/test5_128x128_dynamic_curl_left.dat', left_dim / 2 + 1, left_dim + 1);
Ar = read_bin('../data/test5_128x128_dynamic_curl_right.dat', right_dim / 2 + 1, right_dim + 1);
