  ...
  subroutine apply_sbp42(this, out, in, domain, direction)
    ...
    if (direction == 'x') then
      ...
      do i = 0, domain%nx
        ...
        out%f(i, domain%ny) = (24.0_8 / 17.0_8 * in%f(i, domain%ny) - 59.0_8 / 34.0_8 * in%f(i, domain%ny - 1) + 4.0_8 / 17.0_8 * in%f(i, domain%ny - 2) + 3.0_8 / 34.0_8 * in%f(i, domain%ny - 3)) / (domain.dy)
        out%f(i, domain%ny - 1) = (in%f(i, domain%ny) - in%f(i, domain%ny - 2)) / (2.0_8 * domain%dy)
        out%f(i, domain%ny - 2) = (-4.0_8 / 43.0_8 * in%f(i, domain%ny) + 59.0_8 / 86.0_8 * in%f(i, domain%ny - 1) - 59.0_8 / 86.0_8 * in%f(i, domain%ny - 3) + 4.0_8 / 43.0_8 * in%f(i, domain%ny - 4 )) / (domain%dy)
        out%f(i, domain%ny - 3) = (-3.0_8 / 98.0_8 * in%f(i, domain%ny) + 59.0_8 / 98.0_8 * in%f(i, domain%ny - 2) - 32.0_8 / 49.0_8 * in%f(i, domain%ny - 4) + 4.0_8 / 49.0_8 * in%f(i, domain%ny - 5)) / (domain%dy)
      end do
