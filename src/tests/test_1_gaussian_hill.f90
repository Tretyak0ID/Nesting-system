...
do t = 0, Nt
  ...
  call write_field(state%h%subfields(1, 1), multi_domain%subdomains(1, 1), './data/test1h_left.dat', t + 1)
  call write_field(state%h%subfields(2, 1), multi_domain%subdomains(2, 1), './data/test1h_right.dat', t + 1)
