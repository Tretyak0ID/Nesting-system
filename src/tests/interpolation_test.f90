...
do i = f1%is, f1%ie
  f1%f(i, 0) = sin(domain1%x(i))
end do

call interp_1d_sbp42_2to1_ratio(f1, f2, 'fine2coarse')

do i = f%is, f%ie
  f%f(i, 0) = sin(domain2%x(i)) - f2%f(i, 0)
end do

call write_field(f, domain2, './data/test_interp.dat')
